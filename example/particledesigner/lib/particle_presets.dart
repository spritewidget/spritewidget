...
class ParticlePreset {
  static void updateParticles(ParticleWorld world, ParticlePresetType type,
    ...
    switch (type) {
      case ParticlePresetType.defaultPreset:
